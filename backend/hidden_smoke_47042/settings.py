"""
Django settings for hidden_smoke_47042 project.
...
ROOT_URLCONF = 'hidden_smoke_47042.urls'
...
WSGI_APPLICATION = 'hidden_smoke_47042.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_smoke_47042 API",
    "DESCRIPTION": "API documentation for hidden_smoke_47042 App",
    "VERSION": "v1",
}
